...
class AddEditTransactionBottomSheet extends ConsumerStatefulWidget {
  final Transaction? transaction; // null = add new, not null = edit
  ...
  @override
  ConsumerState<AddEditTransactionBottomSheet> createState() => _AddEditTransactionBottomSheetState();
}

class _AddEditTransactionBottomSheetState extends ConsumerState<AddEditTransactionBottomSheet> {
  ...
  void initState() {
    ...
    if (isEditMode) {
      ...
      _selectedType = widget.transaction!.type == TransactionType.income ? 'income' : 'expense';
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            // Quick Amount Selector (only for add mode)
            if (!isEditMode) ...[
              QuickAmountSelector(
                controller: _amountController,
            ...
            BottomSheetActionButtons(
              ...
              confirmText: isEditMode ? 'Cập nhật' : 'Lưu',
